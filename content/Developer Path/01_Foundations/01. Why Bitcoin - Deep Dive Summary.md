# 01. Why Bitcoin - Deep Dive Summary (Class 1)
**Lecturer:** Giacomo Zucco  
**Duration:** 3-Hour Intensive  
**Focus:** Economic Praxeology and Monetary History
...
**Core Thesis:** Bitcoin is the **de-virtualization** of money. It returns us to a physical-like bearer instrument within a digital environment.
...
- **Why not gases/liquids?** Hard to store/transport.
- **Why not toxic/reactive elements?** They kill the owner or disappear (oxidation).
...
- **Negative-Sum (Theft/Violence):** I punch you and take your bread. Wealth is not created; it is transferred and destroyed (your face hurts, resources are spent on armor).
...
- **1971 (Nixon Shock):** The final break from gold. Money became pure **Fiat** (by decree). This led to the **Fiat Life**: a world of debt, disposable goods, and skyrocketing asset prices (Real Estate).

---

## 🏴‍☠️ Part 4: System of Control & The Cypherpunk Solution

### Money as a Surveillance Tool
- Digital money (Credit Cards/Apps) is not money; it is **Centralized Information**.
- **Financial Exclusion:** AML/KYC laws and FATCA act as a 'Pre-Crime' system (Philip K. Dick reference). If the system doesn't like your behavior, your access to wealth is deleted.
